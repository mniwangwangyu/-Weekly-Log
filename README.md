...
### 📅 泰山修改 23
![image](images/notion_2d2ef61d_1.png)

---

### 📅 周报09
![image](images/notion_34cef61d_1.png)

![image](images/notion_34cef61d_2.png)
...
![image](images/notion_345ef61d_1.png)

和Gemini咨询了关于泰山形成和土壤及岩石垂直分层的问题

![image](images/notion_345ef61d_2.png)

![image](images/notion_345ef61d_3.png)

![image](images/notion_345ef61d_4.png)

![image](images/notion_345ef61d_5.png)

AI生成的一些岩石和土壤的肌理图再去PS里面绘制

![image](images/notion_345ef61d_6.png)

再用AI单独把底座剖面自然融合

![image](images/notion_345ef61d_7.png)
...
### 📅 周报07
![image](images/notion_333ef61d_1.png)

![image](images/notion_333ef61d_2.png)
...
![image](images/notion_333ef61d_3.png)

![image](images/notion_333ef61d_4.png)
...
![image](images/notion_330ef61d_1.png)

![image](images/notion_330ef61d_2.png)

---

### 📅 周报05
![image](images/notion_2cbef61d_1.png)

这个是换了区域颜色加强了边界

![image](images/notion_2cbef61d_2.png)

把区域的饱和度降低了一下

![image](images/notion_2cbef61d_3.png)
...
![image](images/notion_2c4ef61d_1.png)
...
![image](images/notion_298ef61d_1.png)

将泰山拔高周围山降低 。我用的学长发在群里的方法

但是山顶变平了，后面我加了一层高斯模糊稍微好一些

![image](images/notion_298ef61d_2.png)

修改后的摄像机位置变低

![image](images/notion_298ef61d_3.png)

参考图

![image](images/notion_298ef61d_4.png)

在地理空间数据云上下载的东北三省DEM有问题，求助学长，拿到了下载DEM数据的网站

http://viewfinderpanoramas.org/Coverage map viewfinderpanoramas_org3.htm

![image](images/notion_298ef61d_5.png)
